...
class DistrictsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create district" do
    assert_difference('District.count') do
      post districts_url, params: { district: { lat: @district.lat, lng: @district.lng, name: @district.name } }, as: :json
    end
  ...
  test "should update district" do
    patch district_url(@district), params: { district: { lat: @district.lat, lng: @district.lng, name: @district.name } }, as: :json
    assert_response 200
  end
